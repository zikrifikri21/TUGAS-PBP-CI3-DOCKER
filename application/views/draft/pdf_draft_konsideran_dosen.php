 ...
 <body>
     <div id="container">
         <section>
             ...
             <h3 style="text-align:center;">
                 PENGANGKATAN DOSEN PEMBIMBING <?php echo strtoupper($sk->jenis_ujian) ?> MAHASISWA<br>
             ...
             <div class="div" style="padding-left: 0em;">
                 <table style="border:1px; font-family: Arial; font-size: 14px; font-style: normal; font-variant: normal; font-weight: 400; line-height:1;">
                     ...
                     <tr>
                         ...
                         <td colspan="2">
                             Surat Tugas Ketua Jurusan Nomor: <?php echo $sk->no_sk ?> Tentang Surat Penunjukan Dosen Pembimbing.
                         </td>
                     </tr>
                     ...
                     <tr>
                         ...
                         <td colspan="2">
                             Mengangkat mereka yang namanya tersebut dalam lampiran keputusan ini sebagai pembimbing <?php echo ucwords($sk->jenis_ujian) ?> mahasiswa Fakultas Kehutanan dan Ilmu Lingkungan UHO.
                         </td>
                     </tr>
         ...
         <?php if (!empty($sk->status_putusan) && $sk->status_putusan == 'v3') { ?>
             ...
             <?= ZQrcode::get('assets/img/uho.png', $verifikasi, 'M', 3, 0) ?>
         <?php } ?>
     </div>
 </body>

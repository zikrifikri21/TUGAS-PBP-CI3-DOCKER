<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="<?php echo base_url($this->uri->segment(1) . '/dosen') ?>">Manajemen SK</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            <li class="nav-item">
                <a href="#">Tambah SK Pembimbing</a>
            </li>
        </ul>
    </div>
        ...
        <div class="card">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <select required class="form-control select2" multiple name="ujian_id[]" id="ujian_id">
                                ...
                                ?>
                                        <option value="<?= $keys->id ?>"
                                            <?= in_array($keys->id, array_column($ujian_id, 'ujian_id')) ? 'selected' : '' ?>>
                                            <?= $keys->judul . '-' . $keys->jenis_ujian ?>
                                        </option>
                                    <?php } else { ?>
                                        <option value="<?= $keys->id ?>">
                                            <?= $keys->judul . '-' . $keys->jenis_ujian ?>
                ...
                <div class="card-footer">
                    ...
                    <a href="<?php echo site_url('C_sk_dekan/dosen') ?>" class="btn btn-danger btn-sm">

                    ...
                    <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <?php echo form_open("C_sk_dekan/create_dosen", array('method' => 'get')) ?>
                            ...
                            <tbody>
                                <?php if ($sk_dekan) {
                                    ...
                                    foreach ($sk_dekan as $key) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if (!$key->status_putusan || $key->status_putusan == 'v0') { ?>
                                                    <a href="<?php echo site_url('C_sk_dekan/update_dosen/' . $key->id . '?jenis_ujian=' . $key->jenis_ujian) ?>" class="btn btn-warning btn-sm">
                                                ...
                                                <?php } ?>
                                                <?php if (auth('tbl_user_level_id') == '8' || auth('tbl_user_level_id') == '4') { ?>
                                                    <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#verifikasiModal<?= $key->id ?>">
                                                        Verifikasi
                                                    </button>
                                                <?php } ?>
                                            </td>
                                        ...
                                        <div class="modal fade" id="verifikasiModal<?= $key->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <?= form_open('C_sk_dekan/upload_file_dosen'); ?>
                                                    <div class="modal-body">
                                                        ...
                                                        <?php if (auth('tbl_user_level_id') == '4') { ?>
                                                            <div class="form-group">
                                                                <label for="status_putusan-<?= $key->id; ?>">Status Putusan</label>
                                                                <select name="status_putusan" id="status_putusan-<?= $key->id; ?>" class="form-control">
                                                                    <option value="v2">Diterima</option>
                                                                    <option value="v0">Kembalikan Dengan Catatan</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group" id="catatan-tolakan-<?= $key->id; ?>" style="display: none;">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-primary" id="verifikasi-<?= $key->id; ?>">
                                                    ...
                                                    <script>
                                                        $(document).ready(function() {
                                                            $('#status_putusan-<?= $key->id; ?>').on('change', function() {
                                                                if ($(this).val() == 'v0') {
                                                                    $('#catatan-tolakan-<?= $key->id; ?>').slideDown();
                                                                    $('#verifikasi-<?= $key->id; ?>').text('Kembalikan');
                                                                } else {
                                                                    $('#catatan-tolakan-<?= $key->id; ?>').slideUp();
                                                                    $('#verifikasi-<?= $key->id; ?>').text('Kirim Ke Dekan');
                                                                }
                                                            });
                                                        })
                                                    </script>
                                        ...
                                        <div class="modal fade" id="konsideran<?php echo $key->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <?php echo form_open_multipart("C_sk_dekan/upload_file_dosen") ?>
                                                    <div class="modal-body">
                                                        <embed src="<?php echo base_url() . 'C_draft/sk_dekan_konsideran_dosen/' . $key->id ?>" frameborder="0" width="100%" height="600px">
                                                        <!-- <div class="form-group">
                                                    ...
                                                    <?php if (auth('nama_level') === "Staf Akademik" && $key->status_putusan !== "v3") { ?>
                                                        <div class="modal-footer">
                                        ...
                                        <div class="modal fade" id="lampiran<?php echo $key->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <?php echo form_open_multipart("C_sk_dekan/upload_file_dosen") ?>
                                                    <div class="modal-body">
                                                        <embed src="<?php echo base_url() . 'C_draft/sk_dekan_lampiran_dosen/' . $key->id ?>" frameborder="0" width="100%" height="600px">
                                                        <!-- <div class="form-group">
                                                            <label for="text-input" class=" form-control-label">Upload Ulang File Berisi TTD (Scan PDF)</label>
                                        ...
                                        <div class="modal fade" id="ujianRemoveModal<?php echo $key->id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <?php echo form_open("C_sk_dekan/delete_dosen") ?>
                                                    <div class="modal-body">
